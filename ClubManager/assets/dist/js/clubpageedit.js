...
piranha.clubpageEdit = new Vue({
    ...
    methods: {
        ...
        load: function (id) {
            var self = this;
            console.log("Loading Page Edit!!!");
            console.log(piranha.baseUrl + "manager/api/clubpage/" + id);
            fetch(piranha.baseUrl + "manager/api/clubpage/" + id)
